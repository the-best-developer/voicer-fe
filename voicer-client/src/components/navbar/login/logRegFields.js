...
const LogRegFields = (props) => {
    ...
    const doSubmit = e => {
        ...
        if (make.length !== 0) {
            ...
            axios
                .post(title === "Register" ? `${url}/api/auth/register` : `${url}/api/auth/login`, userInfo)
                .then(res => {
    ...
    return (
        <section>
            <form onSubmit={doSubmit}>
                ...
                <Card.Footer>
                    <Button variate="primary" type="submit" style={{ width: "10rem", margin: "0 0 1.75rem" }}>
                        Join!
                    </Button>
            ...
            <button
                onClick={(e)=>props.loginRegisterHandler(e)}
            >I want to {notTitle} instead</button>
        </section>
    );
};
