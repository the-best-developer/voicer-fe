...
import { getLanguages, getAccents } from '../actions/register';
                            ...
                            <div className="input-box-cols">
                                <div>
                                    ...
                                    <div className="dropdown-div">
                                        <Dropdown
                                            ...
                                            toggle={() =>
                                                this.setState({
                                                    toggleDropGender: !this
                                                        .state.toggleDropGender
                                                })
                                            }
                                            className="dropdown"
                                        >
                                ...
                                <div>
                                    ...
                                    <div className="dropdown-div">
                                        <Dropdown
                                            isOpen={
                                                this.state.toggleDropUserType
                                            }
                                            toggle={() =>
                                                this.setState({
                                                    toggleDropUserType: !this
                                                        .state
                                                        .toggleDropUserType
                                                })
                                            }
...
const mapStateToProps = state => ({
    ...
    languages: state.registerReducer.languages,
    accents: state.registerReducer.accents
});
