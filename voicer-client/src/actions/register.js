...
export const createClientProfile = creds => dispatch => {
    ...
    return axiosWithAuth()
        .post(
            'https://voicer-lambda-app-staging.herokuapp.com/api/clients/',
            creds
        )
...
export const createTalentProfile = creds => dispatch => {
    ...
    return axiosWithAuth()
        .post(
            'https://voicer-lambda-app-staging.herokuapp.com/api/talents/',
            creds
        )
        .then(res => dispatch({ type: CREATE_PROFILE_SUCCESS }))
        .catch(err => {
...
export const getLanguages = () => dispatch => {
    ...
    return axios
        .get(
            'https://voicer-lambda-app-staging.herokuapp.com/api/auth/languages'
        )
        .then(res => {
            dispatch({
